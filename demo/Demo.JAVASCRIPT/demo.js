...
/*
    ...
    Same for "CODING HTML#CSS#JAVASCRIPT MADE EASY" book.
...
var messageTextTWO = "How old are you?"
var askNameFormStranger = window.prompt("'Knock Knock Who's there?' Oh no there is a stranger outside... respond to him! 1st meassge: " + messageTextONE);
...
if (threeMoreOptions = "") {
    ...
    if (_secretNumber = isNaN) {
        ...
        window.alert("Here is your number: " + $noGenerate[0])
    } else {
        window.alert("Here is your number: " + $noGenerate[1])
    }
}
window.alert("You should be able to now remember it well.");
window.alert("Bye!!!")
